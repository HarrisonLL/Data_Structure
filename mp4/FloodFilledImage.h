...
private:
  ...
  PNG image_;
  std::vector<ImageTraversal *> trav_; // vector of pointers pointed to pixels of original picture
  std::vector<ColorPicker *>color_;  // vector of pointers pointed to pixels of colorPicker
